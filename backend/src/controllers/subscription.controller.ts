    ...
    res.json([
      {
        plan: "BASICO",
        nombre: "Básico",
        descripcion: "Envíos preferenciales y soporte prioritario.",
      ...
      },
      {
        plan: "ESTANDAR",
        nombre: "Estándar",
        descripcion: "Todo lo anterior + ofertas exclusivas.",
      ...
      },
      {
        plan: "PLUS",
        nombre: "Plus",
        descripcion: "Plan anual: envíos gratis ilimitados + 50% off en todo.",
        mensual: null,
